...
def limpiar_codigo_creacion(codigo_creacion, tablas_incremento : list[str]) -> str:
    ...
    table_name : str = ""
    while i < longitud:
        if(codigo_creacion[i] == "P" and codigo_creacion[i+1] == "R" and codigo_creacion[i+2] == "I" and codigo_creacion[i+3] == "M" and codigo_creacion[i+4] == "A" and codigo_creacion[i+5] == "R" and codigo_creacion[i+6] == "Y"):
            print("Creando nueva columna llamada Fecha_signo en " + table_name)
            new_string += "Fecha_signo varchar(255) DEFAULT NULL, "
            new_string += codigo_creacion[i]
            i += 1
        elif(codigo_creacion[i] == "T" and codigo_creacion[i+1] == "A" and codigo_creacion[i+2] == "B" and codigo_creacion[i+3] == "L" and codigo_creacion[i+4] == "E"):
